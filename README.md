...
#app-mount .tierHeaderLocked-3S508x {						/* boostsettings		tierheaderlocked					*/
	background-color: rgba(var(--transparencycolor), .4);
	color: var(--header-secondary);
}
#app-mount .tierHeaderUnlocked-3lTDnP {						/* boostsettings		tierheaderunlocked					*/
	background-color: rgba(var(--transparencycolor), .5);
}
#app-mount .tierCloseClose-iRVkcs {							/* boostsettings		tiercloseclose						*/
	color: var(--header-primary);
}
#app-mount .tierBody-3aUxuc {								/* boostsettings		tierbody							*/
	background-color: rgba(var(--transparencycolor), .3);
	color: var(--header-secondary);
}
...
#app-mount .subscriberCount-11AZJ2 {						/* modal				subcount							*/
	color: var(--header-secondary);
}
#app-mount .subscriberCount-11AZJ2 strong {
	color: var(--text-normal);
}
#app-mount .moreSubscribers-XxaiVS {						/* modal				suboverflow							*/
	background-color: rgba(var(--transparencycolor), .3);
	color: var(--header-primary)
}

#app-mount .subscribersPopout-3tW0Y9 {						/* subpopout			container							*/
	background-color: transparent;
	box-shadow: 0 2px 10px rgba(var(--transparencycolor), .2);
	overflow: hidden;
}
.subscribersPopout-3tW0Y9::before,
.subscribersPopout-3tW0Y9::after {
	content: "";
	position: absolute;
	top: 0;
	bottom: 0;
...
#app-mount .subscribersPopoutUser-4hhgA8 {					/* subpopout			users								*/
	color: var(--header-secondary);
}
...
#app-mount .headerTop-3vNv-a,								/* popout				header inner						*/
#app-mount .activity-2INFPu,								/* popout				activity							*/
#app-mount .aboutMeSection-1Fw5Ia {							/* popout				about me section					*/
	background: transparent;
	border: transparent;
}
...
#app-mount .bodyInnerWrapper-26fQXj,						/* popout				body inner							*/
#app-mount .footer-3UKYOU {									/* popout				footer								*/
	background-color: transparent;
	color: var(--header-secondary);
}
